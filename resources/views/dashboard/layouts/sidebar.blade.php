...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            ...
            {{-- Data Setting --}}
            <li class="w-full mt-6">
                <h6 class="pl-6 font-bold leading-tight uppercase text-xs opacity-60">Setting</h6>
            </li>
            <li class="relative px-6 pt-3">
                @if (Request::is('dashboard/user*'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                @endif
                <a class="{{ Request::is('dashboard/user*') ? 'font-semibold text-purple-600 dark:text-purple-300' : 'text-gray-500 dark:text-gray-100' }} inline-flex items-center w-full text-sm transition-colors duration-150 hover:text-purple-600 dark:hover:text-purple-300" href="{{ route('user') }}">
