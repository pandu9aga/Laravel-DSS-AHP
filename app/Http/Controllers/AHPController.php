...
class AHPController extends Controller
{
    ...
    public function index_perhitungan_utama()
    {
        ...
        $IRRow = DB::table('index_random_consistency')->where('ukuran_matriks', $kriteria->count())->first();
        $IR = $IRRow ? $IRRow->nilai : 0;
    ...
    public function index_perhitungan_kriteria(Request $request)
    {
        ...
        $IRRow = DB::table('index_random_consistency')->where('ukuran_matriks', $kategori->count())->first();
        $IR = $IRRow ? $IRRow->nilai : 0;
